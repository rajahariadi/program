...
//           $data = "INSERT INTO tb_mahasiswa (nim, nama, jenis_kelamin, no_telp, alamat, foto, kode, id_kelas) VALUES ('$nim','$nama','$jeniskelamin','$notelp', '$alamat','$namafile','$jurusan','$kelas')";
...
<div class="card card-primary">
  ...
  <form action="mahasiswa/ex_mahasiswa.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        <div class="col-sm-6">
          <input type="hidden" class="form-control" id="" name="id" placeholder="Nim" required>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="" name="nim" placeholder="Nim" required>
        </div>
      </div>
      <br>
