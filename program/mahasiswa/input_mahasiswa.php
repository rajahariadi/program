...
<body>
  ...
  <form action="mahasiswa/ex_mahasiswa.php" method="POST" enctype="multipart/form-data">
    ...
    <!-- <div class="mb-3">
      ...
      <select class="form-select" name="jurusan" id="exampleFormControlSelect1" aria-label="Default select example">
    ...
    <!-- <div class="input-group">
      <button class="btn btn-outline-primary" name="input" type="button" id="button-addon1">Input</button>
    </div> -->
    <div class="">
